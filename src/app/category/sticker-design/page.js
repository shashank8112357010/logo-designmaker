    ...
    return (
        <section className="w-full max-w-[1920px] mx-auto bg-primaryBlack pb-32">
            ...
            <div className="mt-64 sm:mt-0">
                <ServiceIntro imgSrc="/services/Building Web and App Development.png" heading1="The Power of " heading2="Sticker Design" para1="Sticker designs were more than just ornamental elements. They can be a right tool for self expression as well as brand promotion, or only sparking a conversation. Custom stickers allow you to virgin your unequaled style, elevate your preferred causes,' or even advertise your business." para2="With uninterrupted possibilities for customization, backbone patterns open doors for creativity and self expression." withButton={true} flexDirection="flex-row" />
            </div>
