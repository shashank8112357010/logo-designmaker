...
export default function BagAndToteDesign() {
    ...
    return (
        <section className="w-full max-w-[1920px] mx-auto bg-primaryBlack pb-32">
            ...
            <ServiceDesign imgSrc="/services/SocialMediaDesignBeyond.png" subHeading1="Worked FOR Imaginative, Execution and Promoting Groups" heading1="Elevate Your Mornings with Our " heading2="Bag & Tote Design" para={<span>Our customized <strong>bag and tote design</strong> administrations are explicitly custom-made for imaginative, execution, and promoting groups, offering interesting elements that take care of your requirements:</span>} flexDirection="flex-row-reverse" servicesDesignData={servicesDesignData} />
