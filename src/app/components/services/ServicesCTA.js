...
export default function ServicesCTA({ heading, para, imgSrc }) {
    ...
    return (
        <section className="max-w-[1920px] mx-auto flex justify-center px-4 sm:px-10 lg:px-10 bg-primaryBlack text-white pb-20 pt-20 lg:pt-10">
            <div className="bg-secondaryBlack relative px-6 pl-3 py-2 lg:px-8 rounded-[18px] flex justify-between flex-col lgg:flex-row w-[94%]">
                ...
                <div className="flex justify-center lgg:justify-start relative">
                    <div className="w-[250px] xs:w-[300px] sm:w-[350px] lgg:w-[440px] block h-[200px] xs:h-[250px] sm:h-[290px] lgg:h-[440px] mb-3 relative">
                        <Image src={imgSrc} className="" alt="Call to action logo design" fill />
                    </div>
                </div>
            </div>
