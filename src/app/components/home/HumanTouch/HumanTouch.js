...
export default function HumanTouch() {
    ...
    return (
        <section className=" max-w-[1920px] mx-auto relative bg-primaryBlack text-white pt-0 md:pt-16 pb-16 overflow-hidden">
            ...
            <ul className="flex justify-center cursor-pointer gap-5 whitespace-nowrap px-4 min-h-10 leading-[18px] sm:leading-[24px] text-mobTitle2 sm:text-tabTitle2 lg:text-lapTitle2 font-normal text-center overflow-hidden">
