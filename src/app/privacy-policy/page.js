    ...
    return (
        <section className="bg-primaryBlack text-white pt-20 relative max-w-[1920px] mx-auto">
            ...
            <div className="px-4 sm:px-10 lg:px-20">
                <h2 className="text-mobHeading1 pb-4 sm:pb-10 sm:text-tabHeading1 lg:text-lapHeading1 font-bold   leading-[20px] sm:leading-[44px] sm:tracking-[1px]">Interpretation and Definitions</h2>

                <div className="pb-10">
                    <h3 className="font-semibold text-mobTitle sm:text-tabTitle sm:pb-2 lg:text-lapTitle leading-[30px]">
                        Interpretation
                    </h3>
            ...
            <div className="px-4 sm:px-10 lg:px-20">
                <h2 className="text-mobHeading1 pb-10 sm:text-tabHeading1 lg:text-lapHeading1 font-bold leading-[20px] sm:leading-[44px] sm:sm:tracking-[1px]">Collecting and Using Your Personal Data</h2>

                <div className="pb-10">
                    <h3 className="font-semibold text-mobTitle sm:text-tabTitle sm:pb-2 lg:text-lapTitle leading-[30px]">
                        Types of Data Collected
                    </h3>
                    <h4 className="font-semibold text-mobTitle sm:text-tabTitle sm:pb-2 lg:text-lapTitle leading-[30px]">
                        Personal Data
                    </h4>
                    <p className="font-normal leading-[20px] sm:leading-[28px] tracking-[0.2px] text-mobBody sm:text-tabBody lg:text-lapBody">
                    ...
                    <h4 className="font-semibold pt-8 text-mobTitle sm:text-tabTitle sm:pb-2 lg:text-lapTitle leading-[30px]">
                        Usage Data
                    </h4>
                    <p className="font-normal leading-[20px] sm:leading-[28px] tracking-[0.2px] text-mobBody sm:text-tabBody lg:text-lapBody">
            ...
            <div className="px-4 sm:px-10 lg:px-20">
                ...
                <div className="pb-10">
                    <h4 className="font-semibold text-mobTitle sm:text-tabTitle sm:pb-2 lg:text-lapTitle sm:leading-[30px]">
