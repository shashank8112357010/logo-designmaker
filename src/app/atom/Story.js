export default function Story({ content, setContent, arrayData }) {

    return (
        <div className="px-4 sm:px-20 py-8 md:pt-10 items-center md:items-end">
            <div className=" font-bold text-[14px] lg:text-[21px] flex gap-1 sm:gap-2 w-full items-center justify-center md:justify-end flex-wrap">
                {
